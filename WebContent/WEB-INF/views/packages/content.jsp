				...
				<div class="sector">
					...
					<div class="card-deck">
						<div class="card img-fluid packages">
					    	<img class="card-img-top" src="<%=application.getContextPath()%>/resources/img/fukuoka1.jpg" alt="Card image">
							    <div class="card-img img_packages">
							      <h4 class="card-title">벳푸 온천체험</h4>
							      <p class="card-text">:: 다양한 지옥 온천 체험::</p>
							      <a href="#" class="btn btn-outline-light btn-sm text-dark card_btn">바로가기</a>
							    </div>
						</div>
						<div class="card img-fluid packages">
					    	<img class="card-img-top" src="<%=application.getContextPath()%>/resources/img/hawaii1.jpg" alt="Card image">
							    <div class="card-img img_packages">
