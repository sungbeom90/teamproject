								...
								<input type="hidden" id="member_id" name="member_id" value="${mstatus.member_id}"/>
									<ul>
										...
										<li>
											...
											<input type="number"  id="maccount" name="maccount" placeholder="충전 할 금액을 입력해주세요." style="width:40%;"/><br/>
											<a class="btn btn-outline-primary btn-sm" href="javascript:maccountupdate()">충전하기</a>
										</li>
