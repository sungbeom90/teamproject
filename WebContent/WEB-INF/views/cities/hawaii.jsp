	...
	<div class="wrap">
		...
		<div class="mainCenter">
			...
			<div class="content container">
				<div class="sector">
				<div class="head" style="background-image:url('<%=application.getContextPath()%>/resources/img/hawaii_head.jpg')">
				하 와 이
				</div>
						<h2>추천 상품</h2>	 				
				<div class="card-deck">
					<div class="card img-fluid cities">
					    <img class="card-img-top img_center" src="<%=application.getContextPath()%>/resources/img/hawaii1.jpg" alt="Card image">
						    <div class="card-img-overlay">
						      ...
						      <a href="<%=application.getContextPath()%>/offers/hawaii_offer1" class="btn btn-outline-light btn-sm stretched-link">바로가기</a>
						    </div>
					</div>
					...
					<div class="card img-fluid cities">
					    <img class="card-img-top img_center" src="<%=application.getContextPath()%>/resources/img/hawaii2.jpg" alt="Card image">
						    <div class="card-img-overlay">
						      ...
						      <a href="<%=application.getContextPath()%>/offers/hawaii_offer2" class="btn btn-outline-light btn-sm stretched-link">바로가기</a>
						    </div>
					</div>
				</div>
			  </div>
